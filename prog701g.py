...
def main():
  try:
    ...
    with open("Langdat/prog701g.dat", 'r') as f:
      ...
      totStus = 0
      large = ""
      small = "aoiyefkjsahdfiuhyewakjhfikjsadgflkjhaelkjghkjsadhflkjajselkfjealkfujlkdxajflknefkmbadlkjfiaeufasufesaehfkjhdkjfhaekjfhkjahdkjfhesakjfkjahsekjfhkjahesfkjhasekfhakjhfkjahekjfhaskjhfkjehfaekjfhjaeshfkjhaekjhfakjhekjhesfkjhaselkjfh"
