...
choice = input("Do you want to be server of client (s/c): ")
...
if choice == "s":
  ...
  public_partnet = rsa.PublicKey.load_pkcs1(client.recv(1024))
  ...
  public_parnet = rsa.PublicKey.load.pkcs1(client.recv(1024))
  client.send(public_key.save_pkcs1())
  print("Use 'Ctrl+C' to disconnect.")
else: exit()
